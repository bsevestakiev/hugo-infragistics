...
{{< figure src="/images/uploads/sebastien-jermer-ty9wjiijyj0-unsplash.jpg" legend="凡例" >}}

## アудィエンスマスキューリング

このサイトでは、アーディエンスマスキューリングを使用していません。

## クッキー

サイトのアーディエンスを追跡していないため、クッキーは使用していません。ですので、承認または拒否する必要はありません。