...
{{< figure src="/images/uploads/sebastien-jermer-ty9wjiijyj0-unsplash.jpg" legend="キャプション" >}}

## アクセス解析

このサイトでは、アクセス解析を使用していません。

## クッキー

サイトのアクセス解析を行っていないため、クッキーは使用していません。したがって、同意または拒否していただく必要はありません。